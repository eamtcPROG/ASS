...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription(
      'HTTP API for the Product service. Manage products and other product-related operations with versioned endpoints, validation, and standard error responses.',
    )
    .addBearerAuth(
      {
